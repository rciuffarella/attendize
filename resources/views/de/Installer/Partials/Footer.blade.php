<div class="well">
    <p>
        Die Installation kann einige Minuten in anspruch nehmen, sobald Sie  '<b>EventiOne Installieren</b>' drücken. Die Konfiguration wird in folgende Datei geschrieben: <b>{{base_path('.env')}}</b>. In Zukunft können Sie änderungen in dieser Datei vornehmen.
    </p>
    <p>
    ...
    <p>
        Sollten Sie bei einem "Shared Hoster" sein, fragen sie diesen ob er alle Anforderungen für EventiOne erfüllt, bevor sie Support in Anspruch nehmen.
    </p>
    <p>
