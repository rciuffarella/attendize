<div class="well">
    <p>
        Installation may make take several minutes to complete. Once you click '<b>Install EventiOne</b>' the config settings will be written to this file: <b>{{base_path('.env')}}</b>. You can manually change these settings in the future by editing this file.
    </p>
    <p>
    ...
    <p>
        Please also  <a style="text-decoration: underline;" target="_blank" href="https://www.attendize.com/license.html">read the licence</a> before installing EventiOne.
    </p>
</div>
