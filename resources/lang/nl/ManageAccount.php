...
return array(
  ...
  'licence_info_description' => 'EventiOne is gelicenseerd onder <b><a target="_blank" href="https://tldrlegal.com/license/attribution-assurance-license-(aal)#summary">Attribution Assurance Licence (AAL)</a></b>. Deze licnetie verplicht tot het plaatsen van  <b>\'Powered By Attendize\'</b> melding op iedere pagina. Indien u deze wenst te verwijderen dient u een white-label licentie aan te schaffen <b><a target="_blank" href="https://attendize.com/license.html">klik hier </a>voor verdere informatie</b>.',
  ...
  'open_source_soft_description' => 'EventiOne is gebouwd met fantastische open-source libraries. Een overzicht hier van kan je vinden op <b><a href="https://libraries.io/github/EventiOne/EventiOne?ref=EventiOne_About_Page" target="_blank">libraries.io</a></b>.',
  'payment' => 'Betaling',
  ...
  'version_out_of_date' => 'De versie (<b>:installed</b>) van EventiOne is niet up to date. De laatste versie is: (<b>:latest</b>) en kan worden <a href=":url" target="_blank">gedownload hier</a>',
  'version_up_to_date' => 'Je EventiOne versie (<b>:installed</b>) is up to date!',
