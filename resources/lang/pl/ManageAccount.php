...
return array (
  ...
  'licence_info_description' => 'EventiOne jest dystrybuowany w ramach licencji <b><a target="_blank" href="https://tldrlegal.com/license/attribution-assurance-license-(aal)#summary">Attribution Assurance Licence (AAL)</a></b>. Ta licencja wymaga użycia klauzuli <b>\'Powered By Attendize\'</b> w każdej kopii EventiOne. Jeżeli chcesz ją usunąć, musisz wykupić osobną licencję <b><a target="_blank" href="https://attendize.com/license.html">znajdującą się tutaj</a></b>.',
  ...
  'open_source_soft_description' => 'EventiOne został zbudowany przy użyciu mnóstwa fantastycznych otwartych bibliotek. Możesz je przejrzeć tu: <b><a href="https://libraries.io/github/EventiOne/EventiOne?ref=EventiOne_About_Page" target="_blank">libraries.io</a></b>.',
  'payment' => 'Opłaty',
  ...
  'version_out_of_date' => 'Twoja wersja aplikacji EventiOne (<b>:installed</b>) jest nieaktualna. Najnowsza wersja (<b>:latest</b>) jest gotowa do <a href=":url" target="_blank">pobrania tutaj</a>',
  'version_up_to_date' => 'Twoja wersja aplikacji EventiOne (<b>:installed</b>) jest aktualna!',
